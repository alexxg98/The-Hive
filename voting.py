...
class VotingPage:
    ...
    def __init__(self):
        ...
        self.win.geometry('{}x{}'.format(600, 450))
        self.canvas = Canvas(self.win, bg='#454b54')
        self.frame = Frame(self.canvas, bg='#454b54', width=300, height=340)

        self.VIPlist = StringVar()

        self.votepage = Text(self.frame, width=50, height=15)
